...
% in MATLAB, broadcasting starts from the left. In TensorFlow, broadcasting 
% starts from the right. For this reason, we will permute x and y to 
% match the reverse TensorFlow dimension. Using rank, we will know with certainty 
% the correct permutation to reverse dimensions. We will assume 
% non-Deep Learning Toolbox 
% formatted arrays are already in reverse TensorFlow dimension. 
