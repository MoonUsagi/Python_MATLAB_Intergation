classdef aten__add2 < nnet.layer.Layer & nnet.layer.Formattable
    %aten__add2 Auto-generated custom layer
    ...
    methods
        function obj = aten__add2(Name, Type, InputNames, OutputNames)
            obj.Name = Name;
            obj.Type = Type;
            obj.NumInputs = 2;
            obj.NumOutputs = 1;
        ...
        function [add_input_1] = predict(obj,add_6, add_argument1_1)
            ...
            if ~contains(dims(add_6),'U')
                ...
                [add_6] = struct('value', add_6, 'rank', ndims(add_6));
                warning(message('nnet_cnn_pytorchconverter:pytorchconverter:PossibleLossOfRank', 'add_6', 'aten__add2'));
            end
            ...
            if ~contains(dims(add_argument1_1),'U')
                ...
                [add_argument1_1] = struct('value', add_argument1_1, 'rank', ndims(add_argument1_1));
                warning(message('nnet_cnn_pytorchconverter:pytorchconverter:PossibleLossOfRank', 'add_argument1_1', 'aten__add2'));
            end
